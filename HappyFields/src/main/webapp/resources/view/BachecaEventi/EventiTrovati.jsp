...
<head>
  ...
  <title>Eventi Trovati</title>
  <link rel="stylesheet" href="./eventiTrovati.css" type="text/css">
...
<h1 class="titolo-grande">Evento trovato!</h1>
<c:forEach var="evento" items="${eventi}">
  <form class="form-eventi" action="${pageContext.request.contextPath}/partecipaEventoServlet" method="get">
    <tr class="tab-eventi">
      <td class="td-eventi"><c:out value="${evento.nome}"/></td><br>
      <td class="td-eventi"><c:out value="${evento.campo.getIndirizzoCompleto()}"/></td><br>
      <td class="td-eventi"><c:out value="${evento.sport.getNome_s()}"/></td><br>
      <td class="td-eventi"><c:out value="${evento.campo.getNome_c()}"/></td><br>
      <td class="td-eventi"><c:out value="${evento.data}"/></td><br>
      <td class="td-eventi"><c:out value="${evento.ora}"/></td><br>
    </tr>
